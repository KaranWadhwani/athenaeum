...
export default function InsightSec({ sec }) {
  return <div style={{background:C.card,borderRadius:12,padding:22,border:'1px solid '+C.bd}}>
    <p style={{fontFamily:fonts.body,fontSize:10,fontWeight:700,color:C.gold,textTransform:'uppercase',letterSpacing:1.2,marginBottom:10}}>💡 Key Insight</p>
